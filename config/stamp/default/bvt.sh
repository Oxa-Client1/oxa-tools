...
LMS_URL=oxa-client1-learning.$BASE_URL
CMS_URL=oxa-client1-studio.$BASE_URL
...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/Oxa-Client1/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/Oxa-Client1/edx-platform.git
